...
Public usage starts in the repository [README](../README.md). API behavior is
authoritative in `src/index.ts`; changes to emitted declarations are checked by
`api/index.d.ts.sha256`.
